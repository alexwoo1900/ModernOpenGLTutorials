...
public:
    ...
    bool Init()
    {
        ...
        m_pDisplacementMap = new Texture(GL_TEXTURE_2D, "../../asserts/heightmap.jpg");
        ...
        m_pColorMap = new Texture(GL_TEXTURE_2D, "../../asserts/diffuse.jpg");
        ...
        return m_pMesh->LoadMesh("../../asserts/quad2.obj");
    }
