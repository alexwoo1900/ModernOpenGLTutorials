...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pSphereMesh->LoadMesh("../../asserts/box.obj")) {
            return false;
        }
               
        m_pTexture = new Texture(GL_TEXTURE_2D, "../../asserts/bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "../../asserts/normal_map.jpg");
        
        if (!m_pNormalMap->Load()) {
            return false;
        }

        m_pTrivialNormalMap = new Texture(GL_TEXTURE_2D, "../../asserts/normal_up.jpg");
